...
Implementation: `backend/app/llm/client.py` (httpx → Groq OpenAI-compatible API, then Gemini `generateContent`). Models: `GROQ_MODEL` (default `llama-3.3-70b-versatile`), `GEMINI_MODEL` (default `gemini-2.0-flash`).
